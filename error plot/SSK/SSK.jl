...
plot(mesh, A.(mesh), label = "origin A(w)", title = "SSK for smooth type", xlabel = "w", ylabel = "A(w)")
...
plot(mesh, reA0_delta, label = "reconstruct A0(w), noise: 0.0", title = "SSK for delta type", xlabel = "w", ylabel = "A(w)")
