...
plot(output_range,Aout,title = "Error bound, pert = $η",label="origin", xlabel="ω", ylabel="A(ω)")
...
plot(pert,ave_norm,title = "Error bound varies with pertubation",label="||∇L² loss func||", xlabel="pertubation",ylabel = "average norm")
