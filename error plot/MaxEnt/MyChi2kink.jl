...
plot(output_range,A.(output_range),label="origin Spectral ",title="MaxEnt for smooth type",xlabel="ω",ylabel="A(ω)", legendfontsize=7)
...
plot(output_range,Aout0_delta,label="reconstruct A0(ω), noise:0.0", title="MaxEnt for delta type",xlabel="ω",ylabel="A(ω)", legendfontsize=6)
