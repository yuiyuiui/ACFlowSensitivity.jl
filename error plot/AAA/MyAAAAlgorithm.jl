...
# draw the pictures
plot(Amesh, A.(Amesh), label = "origin A(w)", title = "AAA for smooth type", xlabel = "w", ylabel = "A(w)")
plot!(Amesh, reconstruct_A1.(Amesh), label = "reconstruct A1(w), noise: 1e-5", linewidth = 0.5)
plot!(Amesh, reconstruct_A2.(Amesh), label = "reconstruct A2(w), noise: 1e-4", linewidth = 0.5)
plot!(Amesh, reconstruct_A3.(Amesh), label = "reconstruct A3(w), noise: 1e-3", linewidth = 0.5)
plot!(Amesh, reconstruct_A0.(Amesh), label = "reconstruct A0(w), noise: 0.0", linewidth = 0.6)
...
plot(mesh, reA0, label = "reconstruct A0(w), noise: 0.0", title = "AAA for delta type", xlabel = "w", ylabel = "A(w)")
