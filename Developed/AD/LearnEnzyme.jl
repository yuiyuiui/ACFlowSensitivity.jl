...
function EnzymeRules.forward(config::FwdConfig, func::Const{typeof(f)}, ::Type{<:Duplicated}, y::Duplicated, x::Duplicated)
...
function EnzymeRules.forward(config::FwdConfig, func::Const{typeof(ll)}, ::Type{<:Duplicated}, y::Duplicated, x::Duplicated)
    ret = func.val(y.val, x.val)
...
function EnzymeRules.forward(config::FwdConfig, func::Const{<:Line}, ::Type{<:Duplicated}, y::Duplicated, x::Duplicated)
    @show func.val.k
    ret = func.val(y.val, x.val)
...
function EnzymeRules.forward(config::FwdConfig, func::Const{typeof(my_func)}, ::Type{<:Duplicated}, y::Duplicated, x::Duplicated)
    y.dval .= 1.0
...
function EnzymeRules.forward(config::FwdConfig, func::Const{<:my_Line}, ::Type{<:Duplicated}, x::Duplicated)
    ret = func.val(x.val)
...
function EnzymeRules.forward(config::FwdConfig, func::Const{typeof(my_func)}, ::Type{<:Duplicated}, x::Duplicated)
    ret = func.val(x.val)
