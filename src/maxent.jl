...
function _ADchi2kink(iwn::Vector{ComplexF64}, Gvalue::Vector{ComplexF64}, output_range::Vector{Float64})
	...
	dpdivdχ²_vec = -pinv(∂²loss_curveDiv∂p²(arg...)) * ∂²loss_∂p∂y(arg...) * diagm( 1 ./ ( χ²_vec * log(10) ) )
	...
	return dA_optdivdG[:,1:N] + im * dA_optdivdG[:,N+1:2*N], dlossdivdG[1:N] + im * dlossdivdG[N+1:2*N]
end
